...
export const hydrostaticsMath = {
  ...
  'forces-21': {},
  'forces-22': {
    prompt: mt`A quarter-circular gate has radius ${im(String.raw`R=1.00\,\mathrm{m}`, 'R = 1.00 m')} and width ${im(String.raw`b=1.00\,\mathrm{m}`, 'b = 1.00 m')}. Its centre of curvature is at the free surface. Water occupies the quarter-cylinder above the arc, from the surface down to the point directly below the centre. Find the magnitude of the vertical water-force component.`,
    given: mt`The water is at rest. The free surface and the other side of the gate are at atmospheric pressure. ${im(String.raw`\rho=1000\,\mathrm{kg/m^3}`, 'ρ = 1000 kg/m³')} and ${im(String.raw`g=9.80\,\mathrm{m/s^2}`, 'g = 9.80 m/s²')}.`,
    solution: [mt`The water volume above the arc is ${dm(String.raw`\begin{aligned}V&=\frac{\pi R^2b}{4}\\&=\frac{\pi\times1.00^2\times1.00}{4}\\&=0.785398\,\mathrm{m^3}.\end{aligned}`, 'V = πR²b / 4 = π × 1.00² × 1.00 / 4 = 0.785398 m³.')}`, mt`The vertical component has magnitude ${dm(String.raw`\begin{aligned}F_{\mathrm V}&=\rho gV\\&=\frac{1000\times9.80\times0.785398}{1000}\\&=7.697\,\mathrm{kN}\end{aligned}`, 'F_V = ρgV = 1000 × 9.80 × 0.785398 / 1000 = 7.697 kN')} and acts downward.`],
  },
  'forces-23': {
    prompt: mt`A quarter-circular gate has radius ${im(String.raw`R=1.00\,\mathrm{m}`, 'R = 1.00 m')} and width ${im(String.raw`b=1.00\,\mathrm{m}`, 'b = 1.00 m')}. The arc runs from the free surface to the point directly below its centre of curvature, which is at the surface. Water occupies the quarter-cylinder above the arc. Find the magnitude of the resultant water force on the gate.`,
    given: mt`The water is at rest. The free surface and the other side of the gate are at atmospheric pressure. ${im(String.raw`\rho=1000\,\mathrm{kg/m^3}`, 'ρ = 1000 kg/m³')} and ${im(String.raw`g=9.80\,\mathrm{m/s^2}`, 'g = 9.80 m/s²')}.`,
    hint: mt`Use the vertical projection for ${im(String.raw`F_{\mathrm H}`, 'F_H')} and the water volume above the arc for ${im(String.raw`F_{\mathrm V}`, 'F_V')}. Then combine the perpendicular components.`,
    solution: [mt`The vertical projection has area ${im('bR')} and centroid depth ${im(String.raw`\frac R2`, 'R / 2')}, so ${dm(String.raw`F_{\mathrm H}=\frac{\rho gbR^2}{2}=4.900\,\mathrm{kN}.`, 'F_H = ρg bR² / 2 = 4.900 kN.')}`, mt`The quarter-cylinder volume gives ${dm(String.raw`F_{\mathrm V}=\frac{\rho g\pi R^2b}{4}=7.697\,\mathrm{kN}`, 'F_V = ρgπR²b / 4 = 7.697 kN')} downward.`, mt`The resultant is ${dm(String.raw`\begin{aligned}F_{\mathrm R}&=\sqrt{F_{\mathrm H}^2+F_{\mathrm V}^2}\\&=\sqrt{4.900^2+7.696902^2}\\&=9.124\,\mathrm{kN}.\end{aligned}`, 'F_R = √(F_H² + F_V²) = √(4.900² + 7.696902²) = 9.124 kN.')}`, mt`Its direction is ${im(String.raw`\alpha=\tan^{-1}\!\left(\frac{F_{\mathrm V}}{F_{\mathrm H}}\right)=57.52^{\circ}`, 'α = tan⁻¹(F_V / F_H) = 57.52°')} below the horizontal, away from the water.`],
  },
};
